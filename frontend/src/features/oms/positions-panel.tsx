          ...
          {positions.map((position) => {
            ...
            return (
              <div 
                key={position.id}
                className={cn(
                  "grid grid-cols-7 gap-2 text-xs font-mono py-2 px-2 rounded-md transition-colors",
              ...
              >
                ...
                <div className="text-right">${position.currentPrice.toLocaleString(undefined, { minimumFractionDigits: 2 })}</div>
        ...
        <div className="space-y-2 max-h-[250px] overflow-y-auto">
          ...
          {orders.map((order) => {
            ...
            return (
              <div 
                key={order.id}
                className="grid grid-cols-6 gap-2 text-xs font-mono py-2 px-2 rounded-md hover:bg-secondary/50 transition-colors"
              >

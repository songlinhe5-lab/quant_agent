            ...
            <tbody className="divide-y divide-border/15">
              {loadingLogs ? (
                ...
                const typeColor = isBlock
                  ? 'text-[hsl(var(--bear))] dark:text-[hsl(var(--bear))] bg-[hsl(var(--bear))]/10 border-[hsl(var(--bear))]/20'
                ...
                return (
                  <tr key={log.id} className="hover:bg-muted/50 transition-colors group">
                    ...
                    <td className={cn('px-4 py-3 text-right font-mono font-bold tabular-nums', isBlock ? 'text-[hsl(var(--bear))] dark:text-[hsl(var(--bear))]' : 'text-amber-600 dark:text-amber-500')}>
            ...
            <tbody className="divide-y divide-border/15">
              {loadingFrontendLogs ? (
                ...
                const levelColors: Record<string, string> = {
                  ERROR: 'text-[hsl(var(--bear))] dark:text-[hsl(var(--bear))] bg-[hsl(var(--bear))]/10 border-[hsl(var(--bear))]/20',

  ...
  return (
    <div className="glass-card rounded-lg overflow-hidden flex flex-col h-[350px] relative">
      ...
      <div className="px-4 py-2.5 border-b border-border/30 flex items-center gap-2 flex-shrink-0">
        ...
        <span className="text-xs font-semibold text-slate-700 dark:text-slate-300 uppercase tracking-wide">经济日历 · 央行事件</span>
        <div className="ml-auto flex items-center gap-2">
          <button onClick={() => setCalendarInfo(true)} className="flex items-center gap-1 text-[10px] text-slate-500 dark:text-slate-300 hover:text-slate-700 dark:text-slate-300 bg-secondary/30 hover:bg-secondary/60 px-2 py-0.5 rounded-full transition-colors">
            ...
            {[
              ...
              return (
                <button
                  ...
                  className={cn("flex items-center gap-1 text-[10px] px-2 py-0.5 rounded-full transition-colors", active ? `bg-primary/10 text-primary font-bold` : "text-slate-700 dark:text-slate-300 hover:text-foreground")}
          ...
          <select
            ...
            className="bg-secondary/30 border border-transparent hover:bg-secondary/60 text-slate-700 dark:text-slate-300 text-[10px] rounded-full px-2 py-0.5 focus:outline-none focus:ring-1 focus:ring-primary transition-colors"
            aria-label="筛选国家"
          >
              ...
              return (
                <button
                  ...
                  className={cn(
                    ...
                    active ? `${imp.bg} ${imp.color} font-bold` : "text-slate-700 dark:text-slate-300 hover:text-foreground"
                  )}
      ...
      <div className="flex items-center gap-1 px-3 py-1 border-b border-border/20 bg-secondary/10 flex-shrink-0">
        <span className="text-[9px] text-slate-700 dark:text-slate-300 mr-0.5">来源</span>
      ...
      <div className="flex-1 overflow-y-auto custom-scrollbar">
        ...
        <table className="w-full text-xs">
          <thead>
            <tr className="border-b border-border/30 bg-slate-50 dark:bg-secondary/20 sticky top-0 z-10 backdrop-blur-md"><th className="text-left px-3 py-1.5 text-slate-700 dark:text-slate-300 font-medium">日期</th><th className="text-left px-2 py-1.5 text-slate-700 dark:text-slate-300 font-medium">时间</th><th className="text-left px-2 py-1.5 text-slate-700 dark:text-slate-300 font-medium">地区</th><th className="text-left px-2 py-1.5 text-slate-700 dark:text-slate-300 font-medium">事件</th><th className="text-center px-2 py-1.5 text-slate-700 dark:text-slate-300 font-medium">级别</th><th className="text-right px-2 py-1.5 text-slate-700 dark:text-slate-300 font-medium">实际</th><th className="text-right px-2 py-1.5 text-slate-700 dark:text-slate-300 font-medium">预期</th><th className="text-right px-3 py-1.5 text-slate-700 dark:text-slate-300 font-medium">前值</th></tr>
          </thead>
              ...
              return (
                <tr key={i} onClick={() => setSelectedEvent(ev)} className={cn('transition-all cursor-pointer', isHigh ? 'bg-[#f6465d]/5 hover:bg-[#f6465d]/10 border-l-2 border-l-[#f6465d]' : 'opacity-80 hover:opacity-100 hover:bg-slate-50 dark:hover:bg-secondary/30')}>
                  ...
                  <td className="px-2 py-2">
                    <span className={cn("text-[9px] font-bold px-1.5 py-0.5 rounded", isHigh ? "bg-[#f6465d]/15 text-[#e11d48] dark:text-[#f6465d]" : "bg-secondary/60 text-slate-700 dark:text-slate-300")}>{ev.country}</span>

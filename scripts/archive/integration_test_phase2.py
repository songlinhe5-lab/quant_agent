...
from backend.utils.technical_indicators_pro import DEFAULT_INDICATORS, IndicatorConfig, TechnicalIndicatorsEngine
...
def test_bollinger_atr_volatility():
    ...
    print(
        f"  └─ Take Profit: ${suggested_take_profit:.2f} (+{((suggested_take_profit - current_price) / current_price) * 100:.1f}%)"
    )

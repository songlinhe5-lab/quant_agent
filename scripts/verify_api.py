        ...
        "tests": [
            {
                ...
                "path": "/health",
                "params": {},
                "desc": "系统健康检查 (验证 Redis 连通性与 Futu 网关存活状态)",
            },
            {
                "method": "GET",
                "path": "/settings/preferences",
                "params": {},
                "desc": "用户偏好配置 (查询 Redis 中的降级开关与系统设置)",
            },
            {
                "method": "GET",
                "path": "/trade/account",
                "params": {"market": "HK"},
                "desc": "交易账户资产数据 (直连 Futu 获取真实/模拟盘资金与实时持仓明细)",
            },
            {
                "method": "GET",
                "path": "/trade/portfolio",
                "params": {},
                "desc": "内部风控核算 (查询账户全局资产、夏普比率与风险敞口)",
            },
            {
                "method": "GET",
                "path": "/trade/trades",
                "params": {},
                "desc": "本地交易流水 (查询本地 SQLite 中的历史订单记录)",
            },
        ],
    },
    {
        ...
        "tests": [
            {
                "method": "GET",
                "path": "/market/quote",
                "params": {"ticker": "HK.00700"},
                "desc": "实时行情快照 (直连 Futu L2 盘口，若断网则降级 Yahoo)",
            },
            {
                "method": "GET",
                "path": "/market/history",
                "params": {"ticker": "HK.00700", "num": 5},
                "desc": "历史K线趋势 (直连 Futu 历史 K 线额度，支持多周期)",
            },
            {
                "method": "GET",
                "path": "/market/tech-indicators",
                "params": {"ticker": "US.AAPL", "lookback_days": 1},
                "desc": "技术指标矩阵 (请求 Yahoo/Futu K 线并聚合计算 MA/MACD/RSI/布林带)",
            },
            {
                "method": "GET",
                "path": "/market/fundamental/HK.00700",
                "params": {},
                "desc": "公司基本面与估值 (获取 Futu 深度 PE/PB/市值 数据，断连走 Yahoo 备用)",
            },
            {
                "method": "GET",
                "path": "/market/fund-flow",
                "params": {"ticker": "HK.00700"},
                "desc": "资金流向与席位 (Futu 独家主力资金追踪与经纪商排队追踪)",
            },
            {
                "method": "GET",
                "path": "/market/option-chain",
                "params": {"ticker": "US.AAPL"},
                "desc": "股票期权链 (获取 Futu OCC 标准格式的衍生品合约列表)",
            },
            {
                "method": "GET",
                "path": "/macro/calendar",
                "params": {"days_ahead": 7},
                "desc": "宏观经济日历 (调用 Finnhub API 获取高影响经济事件)",
            },
            {
                "method": "GET",
                "path": "/market/search",
                "params": {"q": "AAPL"},
                "desc": "股票代码智能补全 (调用 Yahoo 搜索引擎代理并过滤非股票资产)",
            },
        ],
    },
    {
        ...
        "tests": [
            {
                "method": "GET",
                "path": "/screener/suggestions",
                "params": {"limit": 3},
                "desc": "获取选股灵感 (从后端拉取随机的 NLP 提示词)",
            },
            {
                "method": "POST",
                "path": "/screener/translate",
                "params": {"query": "港股，市值大于100亿，且出现MACD金叉"},
                "desc": "NLP 转 DSL (调用大模型与 RAG 知识库解析意图)",
            },
            {
                "method": "POST",
                "path": "/screener/run",
                ...
                "desc": "在线条件选股 (调用 Futu OpenD 发起多市场扫盘，带服务端分页)",
            },
        ],
    },
]

...
- [x] **[COPILOT-12]** **左导航新增「投研」路由 + 三列布局骨架**：✅ `695323d`
...
- [x] **[COPILOT-13]** **B1 会话中心**：✅ `c6f8992`
  ...
  - 依赖：COPILOT-12
  - 预期工时：FE 6h
- [x] **[COPILOT-14]** **B2 对话模式（宽屏版）**：✅ `9289a8d`
  ...
  - 预期工时：FE 6h
- [x] **[COPILOT-15]** **B2 辩论室·组局态（Proposition Composer）**：✅ `0b6f25d`
  ...
  - 依赖：COPILOT-12
  - 预期工时：FE 8h
- [x] **[COPILOT-16]** **B2 辩论室·辩论态（Debate Room）**：✅ `2d34b27`
  ...
  - 依赖：COPILOT-15
  - 预期工时：FE 10h
- [x] **[COPILOT-17]** **B2 辩论室·收敛态（Chief Report）**：✅ `a56ea54`
...
- [x] **[COPILOT-18]** **B2 资产库**：✅ `2ba9bf4`
  ...
  - 依赖：COPILOT-05
  - 预期工时：FE 4h
- [x] **[COPILOT-19]** **B3 运行信息列（可折叠）**：✅ `ce221d2`
  ...
  - 依赖：COPILOT-12
  - 预期工时：FE 4h
- [x] **[COPILOT-20]** **抽屉头部「展开」按钮**：✅ `328c6dc`

...
class TestCollectorsDict:
    ...
    def test_all_collectors_defined(self):
        """测试所有采集器都已定义"""
        expected_names = ["akshare", "finnhub", "fmp", "yfinance", "cboe_pc_ratio", "quote_publisher"]
...
class TestGetEnabledCollectors:
    ...
    def test_all_collectors_enabled_by_default(self):
        ...
        with mock.patch.dict(os.environ, {}, clear=True):
            ...
            assert set(enabled) == {"akshare", "finnhub", "yfinance", "fmp", "cboe_pc_ratio", "quote_publisher"}

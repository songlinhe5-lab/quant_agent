...
class TechnicalIndicatorsEngine:
    ...
    def _calculate_adx(self, df: pd.DataFrame, params: dict, return_history: bool) -> dict:
        ...
        if return_history:
            ...
            return {"adx_history": [result["adx"]], "plus_di_history": [result["plus_di"]], "minus_di_history": [result["minus_di"]]} if result["adx"] else {}
    ...
    def _calculate_atr_percent(self, df: pd.DataFrame, params: dict, return_history: bool) -> dict:
        ...
        if return_history:
            return {"atr_percent_history": [result["atr_percent"]], "atr_relative_history": [result["atr_relative"]]} if result["atr_percent"] else {}
    ...
    def _calculate_elder_ray(self, df: pd.DataFrame, params: dict, return_history: bool) -> dict:
        ...
        if return_history:
            return {"bull_power_history": [result["bull_power"]], "bear_power_history": [result["bear_power"]], "ema_basis_history": [result["ema_basis"]]} if result["bull_power"] else {}
    ...
    def _calculate_keltner_channels(self, df: pd.DataFrame, params: dict, return_history: bool) -> dict:
        ...
        result = calculate_keltner_channels(
            df, 
            period=params.get("period", 20), 
            atrp_multiplier=params.get("atrp_multiplier", 1.5)
        )
        
        if return_history:
            return {"upper_history": [result["upper"]], "middle_history": [result["middle"]], "lower_history": [result["lower"]]} if result["middle"] else {}

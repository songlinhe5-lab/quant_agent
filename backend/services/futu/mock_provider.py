...
class MockProvider:
    ...
    def mock_history(ticker: str, num: int) -> Dict[str, Any]:
        ...
        return {"status": "success", "ticker": ticker, "data": kl_list, "source": "mock"}
    ...
    def mock_option_chain(ticker: str, expiration_date: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "options": [
                {
                    "option_code": f"US.{ticker.upper().replace('US.','')}240119C00150000", 
                    "option_type": "CALL", 
                    "strike_price": 150.0
                },
                {
                    "option_code": f"US.{ticker.upper().replace('US.','')}240119P00150000", 
                    "option_type": "PUT", 
                    "strike_price": 150.0
                }
            ], 

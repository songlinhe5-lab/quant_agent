...
_ALIAS_MAP = {
    ...
    "FLOAT_MARKET_CAP": "FLOAT_MARKET_VAL", "SHAREHOLDERS_PROFIT_TTM": "SHAREHOLDER_NET_PROFIT_TTM",  # noqa: E501
    "CASH_EQUIVALENTS": "CASH_AND_CASH_EQUIVALENTS", "OPERATING_PROFIT_GROWTH": "OPERATING_PROFIT_GROWTH_RATE",  # noqa: E501
    "TOTAL_ASSETS_GROWTH": "TOTAL_ASSETS_GROWTH_RATE", "SHAREHOLDER_PROFIT_GROWTH": "PROFIT_TO_SHAREHOLDERS_GROWTH_RATE",  # noqa: E501
    "PROFIT_BEFORE_TAX_GROWTH": "PROFIT_BEFORE_TAX_GROWTH_RATE", "NOCF_PER_SHARE_GROWTH": "NOCF_PER_SHARE_GROWTH_RATE",  # noqa: E501
    "OPERATING_PROFIT_TOTAL_RATIO": "OPERATING_PROFIT_TO_TOTAL_PROFIT", "RSI_BOTTOM_DIVERGENCE": "RSI_BOTTOM_DIVERGE",  # noqa: E501
    "RSI_TOP_DIVERGENCE": "RSI_TOP_DIVERGE", "MACD_BOTTOM_DIVERGENCE": "MACD_BOTTOM_DIVERGE",  # noqa: E501
    "MACD_TOP_DIVERGENCE": "MACD_TOP_DIVERGE", "PB_RATE": "PB", "PE_RATE": "PE_TTM",
    "VOLUME_RATIO": "VOLUME_MULTIPLE"
}

_VALID_FIELDS = [
    "MARKET_CAP", "PE_TTM", "PB", "PRICE", "AVG_VOLUME", "AVG_TURNOVER", "TURNOVER_RATIO",  # noqa: E501
    "PRICE_CHANGE_PCT", "AMPLITUDE", "ROE", "ROA_TTM", "DIVIDEND_RATIO", "BASIC_EPS",
    "NET_PROFIT", "REVENUE", "GROSS_PROFIT_RATIO", "OPERATING_MARGIN_TTM", "OPERATING_CASH_FLOW_TTM",  # noqa: E501
    "NET_PROFIT_CASH_COVER_TTM", "DEBT_TO_ASSETS", "PROPERTY_RATIO", "CURRENT_RATIO",
    "HIST_PERCENTILE_PE", "HIST_PERCENTILE_PB", "HIST_PERCENTILE_PS", "REVENUE_GROWTH", "NET_PROFIT_GROWTH",  # noqa: E501
    ...
    "FINANCIAL_COST_RATE", "OPERATING_PROFIT_TTM", "SHAREHOLDERS_PROFIT_TTM", "QUICK_RATIO",  # noqa: E501
    "CURRENT_ASSET_RATIO", "CURRENT_DEBT_RATIO", "EQUITY_MULTIPLIER", "CASH_EQUIVALENTS",  # noqa: E501
    "TOTAL_ASSET_TURNOVER", "FIXED_ASSET_TURNOVER", "INVENTORY_TURNOVER", "ACCOUNTS_RECEIVABLE",  # noqa: E501
    "EBIT_GROWTH_RATE", "OPERATING_PROFIT_GROWTH", "TOTAL_ASSETS_GROWTH", "SHAREHOLDER_PROFIT_GROWTH",  # noqa: E501
    "PROFIT_BEFORE_TAX_GROWTH", "ROIC_GROWTH_RATE", "NOCF_GROWTH_RATE", "NOCF_PER_SHARE_GROWTH",  # noqa: E501
    "OPERATING_REVENUE_CASH_COVER", "OPERATING_PROFIT_TOTAL_RATIO", "DILUTED_EPS", "NOCF_PER_SHARE",  # noqa: E501
...
_TYPE_ENFORCEMENTS = {
    ...
    "accumulate": frozenset(["PRICE_CHANGE_PCT", "AMPLITUDE", "AVG_VOLUME", "AVG_TURNOVER", "TURNOVER_RATIO", "CHANGE_5MIN", "CHANGE_YTD"]),  # noqa: E501
    "simple": frozenset(["MARKET_CAP", "PE_TTM", "PB", "PRICE", "DIVIDEND_RATIO", "BASIC_EPS", "LISTED_DAYS", "PRICE_TO_52W_HIGH", "PRICE_TO_52W_LOW", "HIGH_TO_52W_HIGH", "LOW_TO_52W_LOW", "VOLUME_MULTIPLE", "BID_ASK_RATIO", "LOT_PRICE", "PE_ANNUAL", "PS_TTM", "PCF_TTM", "TOTAL_SHARE", "FLOAT_SHARE", "FLOAT_MARKET_CAP"])  # noqa: E501
}

_FIELD_ZH_MAP = {
    "MACD_GOLD_CROSS": "MACD金叉", "MACD_GOLDEN_CROSS": "MACD金叉", "RSI_OVERSOLD": "RSI超卖",  # noqa: E501
    "KDJ_GOLD_CROSS": "KDJ金叉", "KDJ_GOLDEN_CROSS": "KDJ金叉", "RSI_BOTTOM_DIVERGE": "RSI底背离",  # noqa: E501
    "RSI_TOP_DIVERGE": "RSI顶背离", "MACD_BOTTOM_DIVERGE": "MACD底背离", "MACD_TOP_DIVERGE": "MACD顶背离",  # noqa: E501
    ...
    "PROPERTY_RATIO": "产权比率", "CURRENT_RATIO": "流动比率", "HIST_PERCENTILE_PE": "PE历史分位",  # noqa: E501
    ...
    "PRICE_TO_52W_HIGH": "距52周最高价比例", "CUR_PRICE_TO_HIGHEST52_WEEKS_RATIO": "距52周最高价比例",  # noqa: E501
    "CUR_PRICE_TO_HIGHEST_52WEEKS_RATIO": "距52周最高价比例",
    "PRICE_TO_52W_LOW": "距52周最低价比例", "CUR_PRICE_TO_LOWEST52_WEEKS_RATIO": "距52周最低价比例",  # noqa: E501
...
_SUPPORTED_PATTERNS = frozenset({"macd_gold_cross", "rsi_oversold", "kdj_gold_cross", "rsi_bottom_diverge", "rsi_top_diverge", "macd_bottom_diverge", "macd_top_diverge", "vcp_pattern", "gap_up", "volume_surge_3d", "insider_net_buy"})  # noqa: E501
...
class ScreenerFilter(BaseModel):
    ...
    type: str = Field(description="字段类型：simple, financial, accumulate, plate, exclude_plate, featured, indicator, indicator_pattern, indicator_positional, kline_shape, broker, option")  # noqa: E501
    term: Optional[str] = Field(default=None, description="财务周期，如 ANNUAL, TTM")
    min_value: Optional[float] = Field(default=None, description="最小值（纯数字，百分比需转为小数如 0.05）", serialization_alias="min")  # noqa: E501
    max_value: Optional[float] = Field(default=None, description="最大值（纯数字，百分比需转为小数如 0.05）", serialization_alias="max")  # noqa: E501
    ...
    def fuzzy_match_field(cls, data: Any) -> Any:
        if isinstance(data, dict) and "field" in data:
            ...
            if field_name not in _VALID_FIELDS_SET and f_type not in ["plate", "exclude_plate"]:  # noqa: E501
                ...
                for correct_type, fields in _TYPE_ENFORCEMENTS.items():
                    if data["field"] in fields:
                        if str(data.get("type", "")).lower() != correct_type:
                            print(f"🔧 [Screener] Pydantic 触发强制类型纠偏: {data['field']} 的类型从 {data.get('type')} 被修正为 {correct_type}")  # noqa: E501
...
class ScreenerDecision(BaseModel):
    ...
    technical_patterns: Optional[List[str]] = Field(default=[], description="技术形态，如 ['macd_gold_cross', 'rsi_oversold']")  # noqa: E501
    ...
    def auto_correct_model_hallucinations(self) -> 'ScreenerDecision':
        ...
        if "CN" in [m.upper() for m in self.markets] or "A" in [m.upper() for m in self.markets]:  # noqa: E501
            ...
            if "SH" not in self.markets: self.markets.append("SH")  # noqa: E701
            if "SZ" not in self.markets: self.markets.append("SZ")  # noqa: E701
        ...
        for f in self.filters:
            ...
            if f.field in ["VOLUME_MULTIPLE", "AVG_VOLUME"] and f.days and f.days >= 2:
                print(f"🛡️ [Screener Pydantic] 拦截到非法指令: {f.field} 被大模型附带了 days={f.days}，自动触发降级转移至 volume_surge_3d。")  # noqa: E501
        ...
        for f in self.filters:
            ...
            if field_bounds[bound_key]["min"] > field_bounds[bound_key]["max"]:
                raise ValueError(f"筛选条件存在逻辑互斥冲突：{f.field_zh or f.field}({f.term or '当前'}) 的最小值 ({field_bounds[bound_key]['min']}) 大于最大值 ({field_bounds[bound_key]['max']})，无法匹配到任何标的。")  # noqa: E501
...
class ScreenerService:
    ...
    def reload_rag_corpus(self):
        ...
        default_corpus = [
            {"desc": "毛利率 gross margin", "rule": "- 毛利率(gross_margin) -> GROSS_PROFIT_RATIO (financial)"},  # noqa: E501
            {"desc": "营业利润率 operating margin", "rule": "- 营业利润率(operating_margin) -> OPERATING_MARGIN_TTM (financial)"},  # noqa: E501
            {"desc": "经营现金流 operating cash flow", "rule": "- 经营现金流(operating_cash_flow) -> OPERATING_CASH_FLOW_TTM (financial)"},  # noqa: E501
            {"desc": "盈利现金覆盖率 cash cover", "rule": "- 盈利现金覆盖率(cash_cover) -> NET_PROFIT_CASH_COVER_TTM (financial)"},  # noqa: E501
            {"desc": "资产负债率 debt ratio", "rule": "- 资产负债率(debt_ratio) -> DEBT_TO_ASSETS (financial)"},  # noqa: E501
            {"desc": "产权比率 debt equity ratio", "rule": "- 产权比率(debt_equity_ratio) -> PROPERTY_RATIO (financial)"},  # noqa: E501
            {"desc": "流动比率 current ratio", "rule": "- 流动比率(current_ratio) -> CURRENT_RATIO (financial)"},  # noqa: E501
            {"desc": "PE历史百分位 pe percentile", "rule": "- PE历史百分位(pe_percentile) -> HIST_PERCENTILE_PE (featured)"},  # noqa: E501
            {"desc": "营收同比增长率 revenue growth", "rule": "- 营收同比增长率(revenue_growth) -> REVENUE_GROWTH (financial)"},  # noqa: E501
            {"desc": "净利润同比增长率 net profit growth", "rule": "- 净利润同比增长率(net_profit_growth) -> NET_PROFIT_GROWTH (financial)"},  # noqa: E501
            {"desc": "EPS同比增长率 eps growth", "rule": "- EPS同比增长率(eps_growth) -> EPS_GROWTH_RATE (financial)"},  # noqa: E501
            {"desc": "ROE同比增长率 roe growth", "rule": "- ROE同比增长率(roe_growth) -> ROE_GROWTH_RATE (financial)"},  # noqa: E501
            {"desc": "放量 企稳 量比 爆量 volume up surge stabilize", "rule": "- 放量/量比(volume_ratio) -> 必须映射为 VOLUME_MULTIPLE (simple)，代表当前成交量相对过去均量的倍数。例如放量要求 min_value: 1.5 或 2.0；企稳(stabilize) -> 映射为 PRICE_CHANGE_PCT (accumulate) 限制波动(如 min_value: -0.03, max_value: 0.03)"},  # noqa: E501
            {"desc": "上市天数 上市时间 次新股 listed days", "rule": "- 上市时间/上市天数/次新股(listed_days) -> LISTED_DAYS (simple)，注意：大模型需自行将年/月换算为绝对天数，如1年即 min_value: 365.0；不满3个月即 max_value: 90.0"},  # noqa: E501
            {"desc": "上海 A股 上证 沪市 沪股 上海证券交易所", "rule": "- 市场指定: 沪市/上证 -> 请严格确保最终 JSON 的 markets 数组中包含 \"SH\"，不要混淆为 SZ"},  # noqa: E501
            {"desc": "深圳 A股 深证 深市 深股 深圳证券交易所", "rule": "- 市场指定: 深市/深证 -> 请严格确保最终 JSON 的 markets 数组中包含 \"SZ\"，不要混淆为 SH"},  # noqa: E501
            {"desc": "A股 中国股市", "rule": "- 市场指定: A股/中国股市 -> 请严格确保最终 JSON 的 markets 数组中同时包含 \"SH\" 和 \"SZ\"，绝对不能写成 \"CN\"。"},  # noqa: E501
            {"desc": "日本 日本股市 日股 东京证券交易所", "rule": "- 市场指定: 日本/日股 -> 请确保 markets 数组包含 \"JP\""},  # noqa: E501
            {"desc": "新加坡 新加坡股市 SGX", "rule": "- 市场指定: 新加坡 -> 请确保 markets 数组包含 \"SG\""},  # noqa: E501
            {"desc": "英国 伦敦股市 LSE", "rule": "- 市场指定: 英国 -> 请确保 markets 数组包含 \"UK\""},  # noqa: E501
            {"desc": "换手率 turnover rate ratio", "rule": "- 换手率(turnover_rate) -> 必须映射为 TURNOVER_RATIO (accumulate)，这是一个百分比指标（如 3% 输出 0.03），绝对不能错写成 AVG_TURNOVER(成交额)！"},  # noqa: E501
            {"desc": "成交额 交易额 turnover amount", "rule": "- 成交额/交易额(turnover) -> 必须映射为 AVG_TURNOVER (accumulate)，这是一个代表资金规模的绝对数值，绝对不能错写成 换手率(TURNOVER_RATIO)！"},  # noqa: E501
            {"desc": "创历史新高 突破52周新高 即将新高 接近最高点 price to 52w high", "rule": "- 创历史新高/接近52周新高(price_to_52w_high) -> 必须映射为 PRICE_TO_52W_HIGH (simple)，代表(现价-52周高)/52周高，需转换为真实小数格式。若是“即将创新高/接近新高”，建议设 min_value: -0.05, max_value: 0.0；若是“已突破新高”，建议设 min_value: 0.0"},  # noqa: E501
            {"desc": "跳空高开 高开 gap up", "rule": "- 跳空高开(gap_up) -> 由于底层不支持跨字段计算，请将其降级为技术形态：在最外层 technical_patterns 数组中加入 \"gap_up\"。"},  # noqa: E501
            {"desc": "连续放量 连续三天放量 volume surge 3 days", "rule": "- 连续放量/连续3天放量(continuous volume surge) -> 由于底层量比不支持时间序列，请将其降级为技术形态：在最外层 technical_patterns 数组中加入 \"volume_surge_3d\"。"},  # noqa: E501
            {"desc": "缩量 地量 萎缩 极度萎缩 volume shrink", "rule": "- 缩量/地量(volume_shrink) -> 必须映射为 VOLUME_MULTIPLE (simple)，设置 max_value: 0.5（代表当前量比仅为过去的一半及以下）。"},  # noqa: E501
            {"desc": "均线附近 长期均线 多头排列 均线上方 moving average", "rule": "- 均线附近/均线多头(moving_average) -> 映射为 LONG_ARRANGEMENT (kline_shape)，代表价格处于均线系统上方或多头排列企稳形态。"},  # noqa: E501
            {"desc": "业绩预增 业绩预告 盈利预喜 earnings guidance", "rule": "- 业绩预增/预告(earnings_guidance) -> 请映射为 NET_PROFIT_GROWTH (financial)，并将 term 设为 SURPRISE_LATEST（代表财报预测/快报），设置 min_value > 0（例如预增50%即 min_value: 0.5）。"},  # noqa: E501
            {"desc": "扭亏为盈 业绩扭亏 turnaround", "rule": "- 扭亏为盈(turnaround) -> 必须输出两个独立的 NET_PROFIT (financial) 条件：1. term 设为 SURPRISE_LATEST，min_value: 0.0（代表预告/快报当期盈利）；2. term 设为 ANNUAL，max_value: 0.0（代表上一年度亏损）。"},  # noqa: E501
            {"desc": "连续分红 连续派息 历史分红 continuous dividend", "rule": "- 连续N年分红/派息(continuous_dividend) -> 必须映射为 DIVIDEND_RATIO，且 type 必须设为 financial，term 设为 ANNUAL，min_value: 0.0，lower_included: false，continuous_period: N。⚠️注意：如果同时有“当前股息率>x%”要求，请务必分为两个独立的 filter 输出！"},  # noqa: E501
            {"desc": "短期债务 短期负债 流动负债 没有短期负债 short term debt", "rule": "- 短期债务/流动负债(short_term_debt) -> 映射为 CURRENT_DEBT_RATIO (financial)。若是要求“没有短期负债/无短期债务压力”，请严格限制 max_value: 0.1（代表流动负债占总负债极小），或者配合使用 QUICK_RATIO (financial) 设置 min_value: 1.0 剔除存货水分。"},  # noqa: E501
            {"desc": "行业 板块 概念 银行股 科技股 医药股 消费股 sector industry plate", "rule": "- 行业/板块/概念(industry/plate) -> 映射为 type: \"plate\"（或 \"exclude_plate\" 用于剔除），并将具体的行业名称（如 [\"银行\", \"半导体\", \"医药\", \"消费\"]）放入 value 数组中。注意：不需要自己猜测富途板块代码，直接填中文名称即可！"},  # noqa: E501
            {"desc": "研发投入 研发费用 R&D research", "rule": "- 研发投入/研发费用(R&D) -> 富途底层暂不支持直接筛选研发数据！请忽略此数值条件，但必须根据上下文语义（如“科技先锋”）转化为行业筛选：输出 field: \"STOCK_PLATE\", type: \"plate\", value: [\"科技\"] 等。"},  # noqa: E501
            {"desc": "高管增持 高管买入 内幕交易 净买入 insider net buy", "rule": "- 高管增持/净买入(insider_buy) -> 富途底层不支持，必须降级为另类数据二次过滤：请在最外层 technical_patterns 数组中加入 \"insider_net_buy\"。"}  # noqa: E501
        ]
                ...
                if 'desc' in df.columns and 'rule' in df.columns:
                    for _, row in df.iterrows():
                        if pd.notna(row['desc']) and pd.notna(row['rule']):
                            self._rag_corpus.append({"desc": str(row['desc']).strip(), "rule": str(row['rule']).strip()})  # noqa: E501
        ...
        if emb_api_key:
            ...
            def get_embeddings(texts):
                headers = {"Authorization": f"Bearer {emb_api_key}", "Content-Type": "application/json"}  # noqa: E501
                res = requests.post(f"{emb_base_url}/embeddings", headers=headers, json={"input": texts, "model": emb_model}, timeout=30)  # noqa: E501
        ...
        try:
            ...
            with engine.begin() as conn:
                ...
                for i in track(batches, description="[cyan]🧠 正在向量化 RAG 规则并灌入 PostgreSQL...[/cyan]"):  # noqa: E501
                    b_docs = docs[i:i+batch_size]
                    b_metas = metadatas[i:i+batch_size]
                    b_ids = ids[i:i+batch_size]

                    b_embs = embed_func(b_docs)
                    if not b_embs: continue  # noqa: E701
                    ...
                    for j in range(len(b_docs)):
                        ...
                        """), {"id": b_ids[j], "desc": b_docs[j], "rule": b_metas[j]["rule"], "rtype": rule_type, "emb": emb_str})  # noqa: E501
            ...
            def _query_vectordb():
                ...
                with SessionLocal() as db:
                    ...
                    results = (
                        ...
                        .filter(or_(models.ScreenerRule.user_id == user_id, models.ScreenerRule.user_id.is_(None)))  # noqa: E501
    ...
    async def add_custom_rule(self, desc_text: str, rule_text: str, user_id: int) -> Dict[str, Any]:  # noqa: E501
        ...
        embed_func = getattr(self, "_embed_func", None)
        if not getattr(self, "_pg_enabled", False) or not embed_func:
            return {"status": "error", "message": "向量数据库未启用，无法保存私有规则。"}  # noqa: E501
    ...
    async def get_custom_rules(self, user_id: int) -> List[Dict[str, Any]]:
        ...
        def _get():
            with SessionLocal() as db:
                ...
                return [{"id": r.id, "desc": r.desc_text, "rule": r.rule_text, "type": r.rule_type} for r in rules]  # noqa: E501
            ...
            try:
                for attempt in range(max_retries + 1):
                    ...
                    if not result_dsl or not result_dsl.strip():
                        ...
                        messages.append({"role": "user", "content": "你返回了空内容，请重新生成合法的 JSON。"})  # noqa: E501
                        continue
                ...
                fallback = {
                    ...
                    "markets": ["HK", "SH", "SZ", "US"],
                    "exclude_st": False,
                    "filters": [{"field": "MARKET_CAP", "type": "simple", "term": "ANNUAL", "min_value": 1e10}, {"field": "PE_TTM", "type": "simple", "term": "TTM", "min_value": 10.0, "max_value": 50.0}]  # noqa: E501
                }
    ...
    async def apply_technical_pattern_filtering(self, final_data: List[Dict[str, Any]], tech_patterns: List[str]) -> List[Dict[str, Any]]:  # noqa: E501
        if not final_data:
            return final_data
        ...
        if miss_symbols:
            if not tech_patterns:
                ...
                print(f"⚠️ [Screener] 为防止 API 限流及消耗过多历史K线额度，取消实时批量拉取 {len(miss_symbols)} 只标的的历史K线数据。")  # noqa: E501
        ...
        while True:
            try:
                ...
                with SessionLocal() as db:
                    ...
                    if subs_to_run:
                        print(f"🚀 [Screener Daemon] {current_time_str} - 检测到 {len(subs_to_run)} 个订阅任务到达触发时间...")  # noqa: E501
                        ...
                        for attempt in range(max_retries):
                            try:
                                ...
                                if final_data:
                                    ...
                                    news_list = await asyncio.gather(*[_fetch_latest_news(r['symbol']) for r in top_10], return_exceptions=True)  # noqa: E501

                                    # 💡 组装信息让大模型进行一句话点评
                                    stock_contexts = []
                                    for r, news in zip(top_10, news_list):
                                        if isinstance(news, BaseException): news = ""  # noqa: E701
                                        chg = r.get('chg', r.get('price_change_pct', r.get('change_rate', 0)))  # noqa: E501
                                        news_str = f", 最新动态: {news}" if news else ""
                                        stock_contexts.append(f"- {r.get('name', r['symbol'])} ({r['symbol']}): 今日涨跌 {chg:.2f}%{news_str}")  # noqa: E501
                                    ...
                                    try:
                                        ...
                                        llm_comments = "\n".join([f"- **{r.get('name', r['symbol'])}**: 暂无点评 (LLM 解析失败)" for r in top_10])  # noqa: E501
            ...
            try:
                ...
                if now.hour == 16 and now.minute == 0:
                    ...
                    json_payload = json.dumps({
                        ...
                        "exclude_st": True,
                        "filters": [
                            {"field": "PRICE_CHANGE_PCT", "type": "accumulate", "min_value": 0.05},  # noqa: E501
                            {"field": "AVG_TURNOVER", "type": "accumulate", "min_value": 100000000.0},  # noqa: E501
                            {"field": "TURNOVER_RATIO", "type": "accumulate", "min_value": 0.02}  # noqa: E501
                        ]
                    })
                    ...
                    if final_data:
                        # 排序：按涨跌幅降序
                        final_data.sort(key=lambda x: x.get('change_rate', 0) if x.get('change_rate') is not None else 0, reverse=True)  # noqa: E501
                        top_stocks = final_data[:20] # 截取前 20 只绝对龙头

                        # 2. 调用大模型进行主线概念总结

                        stocks_info = "\n".join([f"- {r.get('name', '')} ({r.get('symbol', '')}): 涨跌幅 {r.get('change_rate', 0):.2f}%, 换手率 {r.get('turnover_rate', 0):.2f}%, 成交额 {r.get('turnover', 0)/1e8:.2f}亿" for r in top_stocks])  # noqa: E501
                        ...
                        try:
                            resp = await llm_service.get_client().chat.completions.create(model=llm_service.get_model(), temperature=0.7, messages=[{"role": "system", "content": "你是一个资深量化交易主脑。"}, {"role": "user", "content": prompt}])  # noqa: E501
                            content = resp.choices[0].message.content
                ...
                if now.hour == 0 and now.minute == 0:
                    ...
                    def _do_clean():
                        ...
                        try:
                            ...
                            with engine.begin() as conn:
                                # 检查表是否存在以防首次启动时报错
                                table_exists = conn.execute(text("SELECT EXISTS (SELECT FROM information_schema.tables WHERE table_name = 'webpage_knowledge_base')")).scalar()  # noqa: E501
                                if table_exists:
                                    res = conn.execute(text("DELETE FROM webpage_knowledge_base WHERE timestamp < :cutoff"), {"cutoff": cutoff_ts})  # noqa: E501
                                    print(f"✅ [Knowledge Base Daemon] 清理成功！共删除 {res.rowcount} 个陈旧网页碎片块。")  # noqa: E501
                        except Exception as e:
    ...
    async def summarize_results(self, stocks: List[Dict[str, Any]]) -> str:
        ...
        news_list = await asyncio.gather(*[_fetch_latest_news(r['symbol']) for r in top_stocks], return_exceptions=True)  # noqa: E501
        ...
        try:
            resp = await llm_service.get_client().chat.completions.create(model=llm_service.get_model(), temperature=0.7, messages=[{"role": "user", "content": prompt}])  # noqa: E501
            content = resp.choices[0].message.content

...
Dev->>GH : 提交代码/创建PR
GH->>WF : 触发 backend.yml/frontend.yml/security.yml
...
## 结论
Quant Agent 的 CI/CD 体系通过 GitHub Actions 实现了从代码提交到生产部署的全链路自动化。后端与前端分别具备独立的门禁与构建流程，结合 Compose 卫生校验、覆盖率门禁与安全扫描，确保代码质量与安全性。镜像构建与容器编排支持多节点部署，内网 Registry 提升跨地域拉取效率。建议团队遵循现有最佳实践，持续完善测试覆盖与监控告警，保障系统稳定演进。
